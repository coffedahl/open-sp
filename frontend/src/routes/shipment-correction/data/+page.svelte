...
<div class="main center column">
	{#if currentObject == ''}
	<Loader />
	<input use:callFocus autofocus type="text" placeholder="Article number" on:keydown={handleKeydown}
		bind:value={input} id="artnr" />
	<button class="enter" on:click={handleButton}>Enter <i class="fas fa-right-to-bracket" /></button>
	...
	<input id="actual" use:callFocus type="number" placeholder="Antal" bind:value={actual} on:keydown={handleKeydown}
		autocomplete="false" />
